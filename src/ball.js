...
discoball.Ball.prototype.buildTriangles = function() {
  ...
  for (var i = 0; i < this.n/2; ++i) {
    ...
    for (var j = 0; j < m; ++j) {
      ...
      var dtheta2 = 0.0025 * Math.random();
      var dtheta3 = 0.0025 * Math.random();
      var dphi0 = 0.0025 * Math.random();
      var dphi1 = 0.0025 * Math.random();
      var dphi2 = 0.0025 * Math.random();
      var dphi3 = 0.0025 * Math.random();
